...
template class unordered_multimap<char, char>;
template class unordered_multimap<signed char, signed char>;
template class unordered_multimap<unsigned char, unsigned char>;
template class unordered_multimap<short, short>;
template class unordered_multimap<unsigned short, unsigned short>;
template class unordered_multimap<int, int>;
template class unordered_multimap<unsigned int, unsigned int>;
template class unordered_multimap<long, long>;
template class unordered_multimap<unsigned long, unsigned long>;
template class unordered_multimap<long long, long long>;
template class unordered_multimap<unsigned long long,
                                  unsigned long long>;

template bool operator==(const unordered_multimap<char,
                                                  char>&,
                         const unordered_multimap<char,
                                                  char>&);
template bool operator==(const unordered_multimap<signed char,
                                                  signed char>&,
                         const unordered_multimap<signed char,
                                                  signed char>&);
template bool operator==(const unordered_multimap<unsigned char,
                                                  unsigned char>&,
                         const unordered_multimap<unsigned char,
                                                  unsigned char>&);
template bool operator==(const unordered_multimap<short,
                                                  short>&,
                         const unordered_multimap<short,
                                                  short>&);
template bool operator==(const unordered_multimap<unsigned short,
                                                  unsigned short>&,
                         const unordered_multimap<unsigned short,
                                                  unsigned short>&);
template bool operator==(const unordered_multimap<int,
                                                  int>&,
                         const unordered_multimap<int,
                                                  int>&);
template bool operator==(const unordered_multimap<unsigned int,
                                                  unsigned int>&,
                         const unordered_multimap<unsigned int,
                                                  unsigned int>&);
template bool operator==(const unordered_multimap<long,
                                                  long>&,
                         const unordered_multimap<long,
                                                  long>&);
template bool operator==(const unordered_multimap<unsigned long,
                                                  unsigned long>&,
                         const unordered_multimap<unsigned long,
                                                  unsigned long>&);
template bool operator==(const unordered_multimap<long long,
                                                  long long>&,
                         const unordered_multimap<long long,
                                                  long long>&);
template bool operator==(const unordered_multimap<unsigned long long,
                                                  unsigned long long>&,
