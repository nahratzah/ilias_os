...
class printf_arg {
 ...
 private:
  union data_t {
    char d_char;
    wint_t d_wint_t;
    uintmax_t /* unsigned char */ d_uchar;
    intmax_t /* signed char */ d_schar;
    intmax_t /* short */ d_shrt;
    uintmax_t /* unsigned short */ d_ushrt;
    intmax_t /* int */ d_int;
    uintmax_t /* unsigned int */ d_uint;
    intmax_t /* long */ d_long;
    uintmax_t /* unsigned long */ d_ulong;
    intmax_t /* long long */ d_llong;
    uintmax_t /* unsigned long long */ d_ullong;
    uintmax_t /* size_t */ d_size_t;
    intmax_t /* ssize_t */ d_ssize_t;
    intmax_t /* ptrdiff_t */ d_ptrdiff_t;
    uintmax_t /* uptrdiff_t */ d_uptrdiff_t;
    intmax_t d_intmax_t;
