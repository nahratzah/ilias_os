...
double atan2(double y, double x) noexcept {
  ...
  static constexpr double pi_o_4  = 7.8539816339744827900E-01; /* 0x3FE921FB, 0x54442D18 */
  static constexpr double pi_o_2  = 1.5707963267948965580E+00; /* 0x3FF921FB, 0x54442D18 */
  static constexpr double pi      = 3.1415926535897931160E+00; /* 0x400921FB, 0x54442D18 */
  static constexpr double pi_lo   = 1.2246467991473531772E-16; /* 0x3CA1A626, 0x33145C07 */
