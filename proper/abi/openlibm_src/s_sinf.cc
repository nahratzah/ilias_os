...
float sinf(float x) noexcept {
  ...
  static constexpr double s1pio2 = 1 * M_PI_2;  /* 0x3FF921FB, 0x54442D18 */
  static constexpr double s2pio2 = 2 * M_PI_2;  /* 0x400921FB, 0x54442D18 */
  static constexpr double s3pio2 = 3 * M_PI_2;  /* 0x4012D97C, 0x7F3321D2 */
  static constexpr double s4pio2 = 4 * M_PI_2;  /* 0x401921FB, 0x54442D18 */
